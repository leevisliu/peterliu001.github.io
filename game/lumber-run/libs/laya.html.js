(function(exports, Laya) {
    ...
    HTMLStyle.ADDLAYOUTED = 512;
    HTMLStyle._PADDING = [0, 0, 0, 0];
    HTMLStyle._HEIGHT_SET = 8192;
    HTMLStyle._LINE_ELEMENT = 65536;
    HTMLStyle._NOWARP = 131072;
    HTMLStyle._WIDTHAUTO = 262144;
    HTMLStyle._BOLD = 1024;
    HTMLStyle._ITALIC = 2048;
    HTMLStyle._CSS_BLOCK = 1;
    HTMLStyle._DISPLAY_NONE = 2;
    HTMLStyle._ABSOLUTE = 4;
    HTMLStyle._WIDTH_SET = 8;
    HTMLStyle.alignVDic = {
        left: 0,
        center: 16,
        right: 32,
    ...
    HTMLStyle.align_Value = {
        0: "left",
        16: "center",
        32: "right"
    };
    HTMLStyle.vAlign_Value = {
        0: "top",
        64: "middle",
        128: "bottom"
    };
    HTMLStyle._ALIGN = 48;
    HTMLStyle._VALIGN = 192;
            ...
            for (var i = 0, n = this.elements.length; i < n; i++) {
                ...
                switch (tCSSStyle.valign) {
                    ...
                    case "middle":
                        ...
                        if (one.eletype == IHtml.HTMLElementType.IMAGE) ddy = dy + tBottomLineY - one.height;
