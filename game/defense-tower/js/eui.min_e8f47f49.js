...
! function(t) {
    ...
    ! function(t) {
        ...
        var n = [],
            ...
            g = ["id", "locked", "includeIn", "excludeFrom"],
            y = [
                ["<", "&lt;"],
                [">", "&gt;"],
                ["&", "&amp;"],
            ...
            m = function() {
                ...
                return e.prototype.$parseCode = function(t, e) {
                                ...
                                if (this.isInnerClass(c)) {
                                    if ("Skin" == c.localName) {
                                        var f = this.parseInnerClass(c),
                                            g = t.exmlConfig.getPropertyType(d, a);
                                        g ? n.addAssignment(r, f, d) : egret.$error(2005, this.currentClassName, d, i(c))
                                    }
                                } else {
                                    var y = c.localName;
                                    if (this.isProperty(c)) {
                                        if (!this.isNormalKey(y)) continue;
                                        var g = t.exmlConfig.getPropertyType(c.localName, a);
                                        if (!g) continue;
                                        if (!c.children || 0 == c.children.length) continue;
                                        this.addChildrenToProp(c.children, g, y, n, r, s, u, e)
                                    } else h.push(c)
                                }
                        }
                        if (0 != h.length) {
                    ...
                    if (p > 1) {
                        ...
                        if (e == u)
                            if (g.localName == u) {
                                var c = [];
                                if (g.children)
                                    for (var y = g.children.length, v = 0; y > v; v++) {
                                        var f = g.children[v];
                                        if (1 == f.nodeType) {
                                            h = this.createFuncForNode(f);
                                            this.getClassNameOfNode(f);
                                ...
                                h = this.createFuncForNode(g);
                                this.getClassNameOfNode(g);
                                h = this.isStateNode(g) ? "[]" : "[" + h + "]"
                            }
                        ...
                        else h = this.formatValue(i, g.text, a)
                    }
                    ...
                    return t && -1 == t.indexOf(".") && -1 == t.indexOf(":") && -1 == g.indexOf(t) ? !0 : !1
                    ...
                    for (var g, y = this.currentXML, v = (this.getClassNameOfNode(y), y.attributes), m = Object.keys(v), $ = m.length, E = 0; $ > E; E++) {
                        var C = m[E],
                            _ = v[C],
                            b = C.indexOf(".");
                        if (-1 != b) {
                            var T = C.substring(0, b);
                            T = this.formatKey(T, _);
                            var S = this.formatValue(T, _, y);
                            if (!S) continue;
                            var x = C.substr(b + 1);
                            g = this.getStateByName(x, y);
                            var I = g.length;
                            if (I > 0)
                                for (var o = 0; I > o; o++) {
                                    var P = g[o];
                                    P.addOverride(new t.EXSetProperty("", T, S))
                                }
                        }
                    }
                            ...
                            if (1 == o.nodeType && !this.isInnerClass(o) && (this.createStates(o), o.namespace != t.NS_W && o.localName))
                                ...
                                if (this.isStateNode(o)) {
                                    ...
                                    if (m.includeIn) b = m.includeIn.split(",");
                                        ...
                                        for (var T = m.excludeFrom.split(","), S = T.length, y = 0; S > y; y++) {
                                            var x = T[y];
                                            this.getStateByName(x, o)
                                        }
                                        S = this.stateCode.length;
                                        for (var y = 0; S > y; y++) v = this.stateCode[y], -1 == T.indexOf(v.name) && b.push(v.name)
                                    }
                                    for (var I = b.length, P = 0; I > P; P++)
                                        if (l = b[P], f = this.getStateByName(l, o), f.length > 0)
                                            for (var g = f.length, y = 0; g > y; y++) v = f[y], v.addOverride(new t.EXAddItems($, E, _.position, _.relativeTo))
                                }
                                for (var L = Object.keys(m), N = L.length, O = 0; N > O; O++) {
                                    ...
                                    if (-1 != a) {
                                        ...
                                        B = this.formatKey(B, d);
                                        var D = this.formatBinding(B, d, o);
                                        if (!D && (d = this.formatValue(B, d, o), !d)) continue;
                                        l = A.substr(a + 1), f = this.getStateByName(l, o);
                                        var g = f.length;
                                        if (g > 0)
                                            for (var y = 0; g > y; y++) v = f[y], D ? v.addOverride(new t.EXSetStateProperty($, B, D.templates, D.chainIndex)) : v.addOverride(new t.EXSetProperty($, B, d))
                                    }
                                }
                            }
                        }
...
! function(t) {
    var e = t.sys.UIComponentImpl,
        i = function(i) {
            function n() {
                var t = i.call(this) || this;
                return t._widthConstraint = 0 / 0, t.$isShowPrompt = !1, t.$promptColor = 6710886, t.$isFocusIn = !1, t.$isTouchCancle = !1, t.initializeUIValues(), t.type = egret.TextFieldType.INPUT, t.$EditableText = {
                    0: null,
                    1: 16777215,
                    2: !1
                }, t
            ...
            }, n.prototype.onTouchBegin = function() {
                this.$isTouchCancle = !1
            }, n.prototype.onTouchCancle = function() {
                this.$isTouchCancle = !0
            }, n.prototype.onfocusIn = function() {
                if (!egret.Capabilities.isMobile && this.$isTouchCancle) return void this.inputUtils.stageText.$hide();
                ...
                return l.prototype.isPlaying = function() {
                    ...
                    if (g > o)
                        if (v = t + (f - o) / h * 2 * this.$scrollFactor, 0 > v || v > e)
                            for (v = t; Math.abs(f) > o;) v -= f, f *= 0 > v || v > e ? s * a : s, y++;
                        else y = Math.log(o / g) / h;
                    else v = t;
                    if (this.target.$getThrowInfo) {
                        var m = this.target.$getThrowInfo(t, v);
                        v = m.toPos
                    }
                    y > 0 ? (this.$bounces || (0 > v ? v = 0 : v > e && (v = e)), this.throwTo(v, y)) : this.finishScrolling()
...
! function(t) {
    ...
    ! function(t) {
        ...
        t.EXBinding = g, __reflect(g.prototype, "eui.sys.EXBinding")
    }(e = t.sys || (t.sys = {}))
}(eui || (eui = {}));
var eui;
! function(t) {
        ...
        var r = ["Point", "Matrix", "Rectangle"],
            ...
            l = function() {
                ...
                return l.prototype.$describe = function(t) {
                    ...
                    for (var c = Object.keys(i).concat(Object.keys(t)), d = c.length, f = t.__meta__, g = 0; d > g; g++) {
                        var y = c[g];
                        if ("constructor" != y && "_" != y.charAt(0) && "$" != y.charAt(0)) {
                            var v = void 0;
                            if (f && f[y]) v = f[y];
                            else if (e(t[y])) v = "Array";
                            else {
                                if (v = typeof t[y], "function" == v) continue; - 1 == o.indexOf(v) && (v = "any")
                            }
                            r[y] = v
                        }
                    }
                ...
                for (var e = 0, i = 0, n = egret.$TempRectangle, o = t.numChildren, s = 0; o > s; s++) {
                    ...
                    if (egret.is(a, r) && a.$includeInLayout) {
                        var h = a.$UIComponent,
                            ...
                            g = void 0,
                            y = void 0;
                        a.getPreferredBounds(n), isNaN(p) || isNaN(c) ? isNaN(l) ? isNaN(p) && isNaN(c) ? g = n.x : (g = isNaN(p) ? 0 : p, g += isNaN(c) ? 0 : c) : g = 2 * Math.abs(l) : g = p + c, isNaN(d) || isNaN(f) ? isNaN(u) ? isNaN(d) && isNaN(f) ? y = n.y : (y = isNaN(d) ? 0 : d, y += isNaN(f) ? 0 : f) : y = 2 * Math.abs(u) : y = d + f;
                        var v = n.width,
                            m = n.height;
                        e = Math.ceil(Math.max(e, g + v)), i = Math.ceil(Math.max(i, y + m))
                    }
                }
                ...
                for (var o = t.numChildren, s = 0, a = 0, h = egret.$TempRectangle, l = 0; o > l; l++) {
                    ...
                    if (egret.is(u, r) && u.$includeInLayout) {
                        var p = u.$UIComponent,
                            ...
                            E = 0 / 0,
                            C = 0 / 0;
                        isNaN(f) || isNaN(g) ? isNaN(m) || (E = Math.round(i * Math.min(.01 * m, 1))) : E = i - g - f, isNaN(y) || isNaN(v) ? isNaN($) || (C = Math.round(n * Math.min(.01 * $, 1))) : C = n - v - y, u.setLayoutBoundsSize(E, C), u.getLayoutBounds(h);
                        var _ = h.width,
                            b = h.height,
                            T = 0 / 0,
                            S = 0 / 0;
                        T = isNaN(c) ? isNaN(f) ? isNaN(g) ? h.x : i - _ - g : f : Math.round((i - _) / 2 + c), S = isNaN(d) ? isNaN(y) ? isNaN(v) ? h.y : n - b - v : y : Math.round((n - b) / 2 + d), u.setLayoutBoundsPosition(T, S), s = Math.max(s, T + _), a = Math.max(a, S + b)
                    }
                }
    ...
    var e = "eui.UIComponent",
        i = function(i) {
            ...
            return __extends(n, i), n.prototype.measureReal = function() {
                ...
                for (g = 0; m > g; g++) {
                    var P = r.getElementAt(g);
                    if (egret.is(P, e) && P.$includeInLayout)
                        if (P.getPreferredBounds(I), x = Math.max(x, I.height), c) _ += I.width;
                        else {
                            var L = P.$UIComponent;
                            isNaN(L[6]) ? S -= I.width : (b += L[6], v = new t.sys.ChildInfo, v.layoutElement = P, v.percent = L[6], v.min = L[12], v.max = L[13], T.push(v))
                        }
                    else $--
                }
                S -= l * ($ - 1), S = S > 0 ? S : 0;
                ...
                if (c) {
                    if (0 > O) {
                        for (N = S / $, g = 0; m > g; g++) y = r.getElementAt(g), egret.is(y, e) && y.$includeInLayout && (y.getPreferredBounds(I), I.width <= N && (S -= I.width, A--));
                        S = S > 0 ? S : 0
                    }
                } else if (b > 0) {
                    this.flexChildrenProportionally(u, S, b, T);
                    var D = 0,
                        R = T.length;
                    for (g = 0; R > g; g++) {
                        v = T[g];
                        var M = Math.round(v.size + D);
                        D += v.size - M, B[v.layoutElement.$hashCode] = M, S -= M
                    }
                    S = S > 0 ? S : 0
                }
                this.$horizontalAlign == egret.HorizontalAlign.CENTER ? E = o + .5 * S : this.$horizontalAlign == egret.HorizontalAlign.RIGHT && (E = o + S);
                var w = o,
                    V = a,
                    H = 0,
                    z = 0,
                ...
                for (g = 0; m > g; g++) {
                    var j = 0;
                    if (y = r.getElementAt(g), egret.is(y, e) && y.$includeInLayout) {
                        if (y.getPreferredBounds(I), k = 0 / 0, c ? (F = 0 / 0, O > 0 ? F = S * I.width / _ : 0 > O && I.width > N && (F = S / A), isNaN(F) || (k = Math.round(F + G), G += F - k)) : k = B[y.$hashCode], d) C = a, y.setLayoutBoundsSize(k, U), y.getLayoutBounds(I);
                        else {
                            var W = 0 / 0,
                                L = y.$UIComponent;
                            if (!isNaN(y.percentHeight)) {
                                var X = Math.min(100, L[7]);
                                W = Math.round(p * X * .01)
                            }
                            y.setLayoutBoundsSize(k, W), y.getLayoutBounds(I), j = (p - I.height) * f, j = j > 0 ? j : 0, C = a + j
                        }
                        y.setLayoutBoundsPosition(Math.round(E), Math.round(C)), H = Math.ceil(I.width), z = Math.ceil(I.height), w = Math.max(w, E + H), V = Math.max(V, C + z), E += H + l
                    }
                }
                ...
                if (d) {
                    for (var b = this.startIndex; p >= b; b++) g = r.getVirtualElementAt(b), egret.is(g, e) && g.$includeInLayout && (g.getPreferredBounds(y), C = Math.max(C, y.height));
                    m = Math.ceil(Math.max(v, C))
                }
                for (var T, S = 0, x = 0, I = 0, P = !1, L = this.elementSizeTable, N = this.startIndex; p >= N; N++) {
                    var O = 0;
                    g = r.getVirtualElementAt(N), egret.is(g, e) && g.$includeInLayout && (g.getPreferredBounds(y), d || (C = Math.max(C, y.height)), c ? (x = a, g.setLayoutBoundsSize(0 / 0, m), g.getLayoutBounds(y)) : (g.getLayoutBounds(y), O = (v - y.height) * f, O = O > 0 ? O : 0, x = a + O), I = Math.max(I, y.height), P || (T = isNaN(L[N]) ? E : L[N], T != y.width && (P = !0)), L[N] = y.width, S = this.getStartPosition(N), g.setLayoutBoundsPosition(Math.round(S), Math.round(x)))
                }
        ...
        i = function(i) {
            ...
            return __extends(n, i), Object.defineProperty(n.prototype, "horizontalGap", {
                ...
                if (this._orientation == t.TileOrientation.COLUMNS) {
                    ...
                    var g = this._rowHeight + l;
                    if (0 >= g) return this.startIndex = 0, this.endIndex = i - 1, !1;
                    var y = e.scrollV,
                        v = y + n[11],
                        m = Math.floor((y - a) / g);
                    0 > m && (m = 0);
                ...
                if (i.prototype.updateDisplayList.call(this, n, r), this.$target) {
                    ...
                    for (var p, c, d, f, g, y = this._orientation == t.TileOrientation.COLUMNS, v = this.startIndex, m = isNaN(this._horizontalGap) ? 0 : this._horizontalGap, $ = isNaN(this._verticalGap) ? 0 : this._verticalGap, E = this._rowCount, C = this._columnCount, _ = this._columnWidth, b = this._rowHeight, T = this.startIndex; u >= T; T++)
                        if (p = this.$useVirtualLayout ? this.target.getVirtualElementAt(T) : this.target.getElementAt(T), egret.is(p, e) && p.$includeInLayout) {
                            switch (y ? (f = Math.ceil((v + 1) / E) - 1, g = Math.ceil((v + 1) % E) - 1, -1 == g && (g = E - 1)) : (f = Math.ceil((v + 1) % C) - 1, -1 == f && (f = C - 1), g = Math.ceil((v + 1) / C) - 1), this._horizontalAlign) {
    ...
    var e = "eui.UIComponent",
        i = function(i) {
            ...
            return __extends(n, i), n.prototype.measureReal = function() {
                ...
                for (g = 0; m > g; g++) {
                    ...
                    if (egret.is(P, e) && P.$includeInLayout)
                        if (P.getPreferredBounds(I), x = Math.max(x, I.width), c) _ += I.height;
                            ...
                            var L = P.$UIComponent;
                            isNaN(L[7]) ? S -= I.height : (b += L[7], v = new t.sys.ChildInfo, v.layoutElement = P, v.percent = L[7], v.min = L[14], v.max = L[15], T.push(v))
                        }
                    else $--
                }
                S -= l * ($ - 1), S = S > 0 ? S : 0;
                ...
                if (c) {
                    if (0 > O) {
                        for (N = S / $, g = 0; m > g; g++) y = r.getElementAt(g), egret.is(y, e) && y.$includeInLayout && (y.getPreferredBounds(I), I.height <= N && (S -= I.height, A--));
                        S = S > 0 ? S : 0
                    }
                } else if (b > 0) {
                    this.flexChildrenProportionally(p, S, b, T);
                    var D = 0,
                        R = T.length;
                    for (g = 0; R > g; g++) {
                        v = T[g];
                ...
                this.$verticalAlign == egret.VerticalAlign.MIDDLE ? C = a + .5 * S : this.$verticalAlign == egret.VerticalAlign.BOTTOM && (C = a + S);
                var w = o,
                    V = a,
                    H = 0,
                    z = 0,
                ...
                for (g = 0; m > g; g++) {
                    var j = 0;
                    if (y = r.getElementAt(g), egret.is(y, e) && y.$includeInLayout) {
                        if (y.getPreferredBounds(I), k = 0 / 0, c ? (F = 0 / 0, O > 0 ? F = S * I.height / _ : 0 > O && I.height > N && (F = S / A), isNaN(F) || (k = Math.round(F + G), G += F - k)) : k = B[y.$hashCode], d) E = o, y.setLayoutBoundsSize(U, k), y.getLayoutBounds(I);
                        else {
                            var W = 0 / 0,
                                L = y.$UIComponent;
                            if (!isNaN(L[6])) {
                            ...
                            y.setLayoutBoundsSize(W, k), y.getLayoutBounds(I), j = (u - I.width) * f, j = j > 0 ? j : 0, E = o + j
                        }
                        y.setLayoutBoundsPosition(Math.round(E), Math.round(C)), H = Math.ceil(I.width), z = Math.ceil(I.height), w = Math.max(w, E + H), V = Math.max(V, C + z), C += z + l
                    }
                }
                this.maxElementSize = x, r.setContentSize(w + s, V + h)
            }, n.prototype.updateDisplayListVirtual = function(i, n) {
                ...
                if (d) {
                    for (var b = this.startIndex; p >= b; b++) g = r.getVirtualElementAt(b), egret.is(g, e) && g.$includeInLayout && (g.getPreferredBounds(y), C = Math.max(C, y.width));
                    m = Math.ceil(Math.max(v, C))
                }
                for (var T, S = 0, x = 0, I = 0, P = !1, L = this.elementSizeTable, N = this.startIndex; p >= N; N++) {
                    var O = 0;
                    g = r.getVirtualElementAt(N), egret.is(g, e) && g.$includeInLayout && (g.getPreferredBounds(y), d || (C = Math.max(C, y.width)), c ? (S = a, g.setLayoutBoundsSize(m, 0 / 0), g.getLayoutBounds(y)) : (g.getLayoutBounds(y), O = (v - y.width) * f, O = O > 0 ? O : 0, S = a + O), I = Math.max(I, y.width), P || (T = isNaN(L[N]) ? $ : L[N], T != y.height && (P = !0)), L[N] = y.height, x = this.getStartPosition(N), g.setLayoutBoundsPosition(Math.round(S), Math.round(x)))
                }
...
! function(t) {
    ...
    ! function(t) {
        ...
        function n(t, e, i, n, r, s, h, l) {
            ...
            var c, d, f, g = u * p >= 0 ? p : -p;
            if (0 != g && i > 0) {
                var y = 1 / g;
                i = Math.max(r, Math.min(h, i)), d = i, f = (t - u * d) * y, f >= s && l >= f && u * d + g * f >= 0 && (c = egret.Point.create(d, f)), f = (-t - u * d) * y, f >= s && l >= f && 0 > u * d + g * f && (!c || a(c.x, c.y, e).width > a(d, f, e).width) && (egret.Point.release(c), c = egret.Point.create(d, f))
            }
            if (0 != u && n > 0) {
                var v = 1 / u;
                n = Math.max(s, Math.min(l, n)), f = n, d = (t - g * f) * v, d >= r && h >= d && u * d + g * f >= 0 && (!c || a(c.x, c.y, e).width > a(d, f, e).width) && (c = egret.Point.create(d, f)), d = (-t - g * f) * v, d >= r && h >= d && 0 > u * d + g * f && (!c || a(c.x, c.y, e).width > a(d, f, e).width) && (egret.Point.release(c), c = egret.Point.create(d, f))
            }
            if (c) return c;
            var m = e.a,
                $ = e.c,
                E = m * $ >= 0 ? $ : -$;
            return o(u, g, t, r, s, h, l, m, E)
        }
        ...
        function r(t, e, i, n, r, s, h, l) {
            ...
            if (0 != g && i > 0) {
                var y = 1 / g;
                i = Math.max(r, Math.min(h, i)), d = i, f = (t - u * d) * y, f >= s && l >= f && u * d + g * f >= 0 && (c = egret.Point.create(d, f)), f = (-t - u * d) * y, f >= s && l >= f && 0 > u * d + g * f && (!c || a(c.x, c.y, e).height > a(d, f, e).height) && (egret.Point.release(c), c = egret.Point.create(d, f))
            }
            if (0 != u && n > 0) {
                var v = 1 / u;
                n = Math.max(s, Math.min(l, n)), f = n, d = (t - g * f) * v, d >= r && h >= d && u * d + g * f >= 0 && (!c || a(c.x, c.y, e).height > a(d, f, e).height) && (egret.Point.release(c), c = egret.Point.create(d, f)), d = (-t - g * f) * v, d >= r && h >= d && 0 > u * d + g * f && (!c || a(c.x, c.y, e).height > a(d, f, e).height) && (egret.Point.release(c), c = egret.Point.create(d, f))
            }
            if (c) return c;
            var m = e.b,
                $ = e.d,
        ...
        function o(t, e, i, n, r, o, s, a, h) {
            ...
            var l, u, p = (i - n * t) / e,
                ...
                g = a * e - t * h;
            return f >= d ? (u = Math.abs(g) < 1e-9 ? i / (t + e) : a * i / g, u = Math.max(d, Math.min(u, f)), l = (i - e * u) / t, egret.Point.create(l, u)) : (p = -(n * t + i) / e, c = -(o * t + i) / e, d = Math.max(r, Math.min(p, c)), f = Math.min(s, Math.max(p, c)), f >= d ? (u = Math.abs(g) < 1e-9 ? -i / (t + e) : -a * i / g, u = Math.max(d, Math.min(u, f)), l = (-i - e * u) / t, egret.Point.create(l, u)) : null)
        }
        ...
        function s(t, e, i, n, r, s, a) {
            ...
            var d = l * p >= 0 ? p : -p,
                f = u * c >= 0 ? c : -c,
                g = l * f - u * d;
            if (Math.abs(g) < 1e-9) return 0 == d || 0 == l || l == -d ? null : Math.abs(l * e - u * t) > 1e-9 ? null : o(l, d, t, n, n, s, a, u, f);
            var y = 1 / g;
            t *= y, e *= y;
            var v;
        ...
        var l = .1,
            ...
            p = function() {
                function t() {}
                return t.fitBounds = function(t, n, r, o, h, p, c, d, f, g, y) {
                    ...
                    if (v = s(t, n, r, m, $, E, C), !v) {
                        ...
                        if (T = i(n, r, o, h, p, c, m, $, E, C)) {
                            var S = a(T.x, T.y, r).width;
                            S - l > t && (egret.Point.release(T), T = null)
                        }
                        v = _ && T ? _.x * _.y > T.x * T.y ? _ : T : _ ? _ : T, egret.Point.release(_), egret.Point.release(T)
                    }
                    return v
                }, t
            }();
