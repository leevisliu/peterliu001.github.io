...
! function(t) {
    ...
    var i = function() {
        function e() {}
        return e.language = "zh-CN", e.os = "Unknown", e.runtimeType = t.RuntimeType.WEB, e.engineVersion = "5.2.16", e.renderMode = "Unknown", e.boundingClientWidth = 0, e.boundingClientHeight = 0, e
    }();
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(i, e), Object.defineProperty(i.prototype, "delay", {
            ...
            return this._currentCount <= this.repeatCount && t.TimerEvent.dispatchTimerEvent(this, t.TimerEvent.TIMER), r && (this.stop(), t.TimerEvent.dispatchTimerEvent(this, t.TimerEvent.TIMER_COMPLETE)), !1
        }, i
    }(t.EventDispatcher);
